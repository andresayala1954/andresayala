<template>
<div class="contenedorparadisiaco">
  <div class="header2" >
  ...
  <br>
    ...
    <div class="details">
      <h3>Plan Lugares Paradisiacos</h3>
      <p>Selecciona el Plan de tu preferencia</p>
      <p><span>Valor por plan $ 750.000 COP</span></p>
      <ol>
        <li>Cabo de la Vela</li>
        <li>Islas de Rosario</li>
        <li>Archipiélago de San Bernardo</li>
        <li>Buceo en San Andrés y Providencia</li>
      </ol>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form v-on:submit.prevent ="processReserva">
                <input type ="text" v-model="createTransaction.usernameDestiny" placeholder="Plan"/>
                <br/>
                <input type ="text" v-model="createTransaction.usernameDestiny" placeholder="Usuario"/>
                <br/><br/>
...
<style>
    .contenedorparadisiaco {
    background: url('~@/../src/assets/paradisiaco.jpg') center center no-repeat;
    height: 700px;
    width: 1520px;
    }
