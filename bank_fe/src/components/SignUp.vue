    ...
    <div class="signUp_user">
        <div class="container_signUp_user">
            ...
            <form v-on:submit.prevent="processSignUp" >
                ...
                <input type="text" v-model="user.tipo_usuario" placeholder="Tipo de Usuario">
                <br>
...
<style>
    ...
    .contenedorSignUp {
    background: url('~@/../src/assets/fondosignup.jpg') center center no-repeat;
    height: 700px;
    width: 1520px;
    }
    .signUp_user{
