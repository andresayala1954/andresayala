<template>
<div class="contenedornaturaleza">
  <div class="header2" >
  ...
  <br>
    ...
    <div class="details">
      <h3>Plan Explora Nuestra Naturaleza</h3>
      <p>Selecciona el Plan de tu preferencia</p>
      <p><span>Valor por plan $ 450.000 COP</span></p>
      <ol>
        <li>Acampar - Camping</li>
        <li>Alojamiento en Glamping</li>
        <li>Alojamiento finca Eje Cafetero</li>
      </ol>
...
<style>
    .contenedornaturaleza {
    background: url('~@/../src/assets/naturaleza.jpg') center center no-repeat;
    height: 700px;
    width: 1520px;
    }
