<template>
<div class="contenedorreconditos">
  <div class="header2" >
  ...
  <br>
    ...
    <div class="details">
      <h3>Plan Explora Lugares Recónditos</h3>
      <p>Selecciona el Plan de tu preferencia</p>
      <p><span>Valor por plan $ 650.000 COP</span></p>
      <ol>
        <li>Támesis</li>
        <li>Bahía Solano</li>
        <li>Raudal de Jirijirimo</li>
        <li>Cascada del Fin del Mundo</li>
      </ol>
...
<style>
    .contenedorreconditos {
    background: url('~@/../src/assets/reconditos.jpg') center center no-repeat;
    height: 700px;
    width: 1520px;
    }
