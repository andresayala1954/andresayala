...
<div class="contenedor">
  <div id="Historial">
    <div class="container">
      ...
      <h2>Reserva:<span>${{ accountByUsername.balance }} COP</span></h2>
      <h2>Último Movimiento:<span>
...
<style>
  ...
  .contenedor {
  background: url('~@/../src/assets/fondoreserva.jpg') center center no-repeat;
  height: 700px;
  width: 1520px;
}
...
#Historial table th {
  ...
  padding-bottom: 12px;
  text-align: left;
  background-color: rgb(18, 114, 158);
  color: white;
}
